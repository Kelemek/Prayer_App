...
export interface UpdatingPrayerTourOptions {
  /** Community prayer cards show “Post update anonymously”; personal cards do not. */
  ...
  startPrayerEncouragementTour(
    ...
    steps.push({
      popover: {
        ...
        description:
          'When Prayer Encouragement is enabled, <strong>Pray For</strong> lets you record that you prayed for a community prayer, personal prayer, or prayer prompt (and on presentation slides). On community cards viewers only see a <strong>total count</strong>—your tap is anonymous. On personal and prompt cards you track your own <strong>{n} Prayers</strong> count.<br><br>You can turn the button or the praying count off for yourself in <strong>Settings</strong> under prayer encouragement on cards. After you tap Pray For, a <strong>cooldown</strong> applies before you can tap again for the same request (personal / prompt cooldown in Settings; community uses the church-wide setting).',
        side: 'bottom',
        align: 'center',
        onNextClick: this.popoverNextKillsTour(),
      },
