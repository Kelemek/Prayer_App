...
@Component({
  ...
  template: `
    <div class="w-full min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white relative">
      ...
      <div 
        [class]="'h-screen flex flex-col justify-center px-3 md:px-6 py-6 transition-all duration-300 relative z-0 ' + (showControls ? 'presentation-content-with-toolbar' : 'pb-6')">
