    ...
    >
        ...
        <section class="space-y-10">
          ...
          <div class="relative">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-200 mb-4">
              Tap the elements below to see how it works inside the app.
            </p>
            <div
              ...
              <div class="mt-4 space-y-4">
                ...
                >
                  ...
                  <p class="text-sm text-gray-600 dark:text-gray-300">
                    See every active request in one place so your church always
                    knows what needs prayer right now.
                  </p>
                  ...
                  >
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-300">
                      ...
                      <strong>Add Update</strong> on a request to post one. You
                      can also mark a prayer as answered from an update.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <p class="text-sm text-gray-600 dark:text-gray-300">
                    These are prayers that have been marked as answered. See how
                    God has been at work and celebrate together as a community.
                  </p>
                  <p class="text-xs text-gray-500 dark:text-gray-500">
                    Mark a request as answered from the app to move it into this
                    view.
                  </p>
                  <div class="flex flex-wrap gap-1 items-center">
                    <button
                ...
                >
                  ...
                  <p class="text-sm text-gray-600 dark:text-gray-300">
                    Prayer prompts are set up by leaders to direct your church’s
                    prayers—for ministries, missionaries, events, and more.
                    They’re not created by users; they focus everyone on what to
                    pray for.
                  </p>
                </div>
                ...
                >
                  ...
                  <p class="text-xs text-gray-500 dark:text-gray-500">
                    ...
                    live in the same simple interface. Organize with categories
      ...
      >
        ...
        >
          ...
          <p class="text-xs text-gray-500 dark:text-gray-400">
            Tap a category on the app to filter the list. Categories are set by
      ...
      >
        ...
        >
          ...
          <p class="text-sm text-gray-600 dark:text-gray-300">
            Tap the badge (or use “Mark all as read” in the app) to clear the
            count. Badges help you see what’s new at a glance without opening
            every list or card.
          </p>
          <p class="text-sm text-gray-600 dark:text-gray-300">
      ...
      >
        ...
        >
          ...
          <p class="text-sm text-gray-600 dark:text-gray-300">
            ...
            >
            or tap a category to see only prayers in that group. The number in
            parentheses is how many prayers are in that category. On the main
