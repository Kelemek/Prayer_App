...
@Component({
  ...
  template: `
    ...
    >
      ...
      <div class="mb-6">
        <div
          class="text-lg md:text-2xl lg:text-3xl leading-relaxed text-gray-800 dark:text-gray-100"
        >
          {{ prayer.description }}
        </div>
      </div>
      ...
      <div class="border-t border-gray-300 dark:border-gray-600 pt-6">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-gray-100 dark:bg-gray-700 rounded-xl p-5 relative">
            ...
            <div
              class="text-base md:text-lg lg:text-xl text-gray-800 dark:text-gray-200"
            >
              {{ update.content }}
            </div>
          </div>
