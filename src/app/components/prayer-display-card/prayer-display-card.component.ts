...
@Component({
  ...
  template: `
    ...
    @if (prayer) {
    <div
      class="presentation-display-card hide-scrollbar bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-h-full overflow-y-auto"
    >
