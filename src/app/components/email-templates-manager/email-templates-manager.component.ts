...
@Component({
  ...
  template: `
    <app-admin-collapsible-section
      ...
      triggerId="email-templates-trigger"
      panelId="email-templates-panel"
    ...
    >
      ...
      @if (isLoading) {
        <app-admin-section-loading message="Loading email templates…" />
      } @else {
        @if (!activeTenantId) {
          <p
      ...
      >
        ...
        <p class="mt-2 text-sm text-red-700 dark:text-red-300">
          Please execute the database migration in Supabase SQL Editor to enable
          email templates.
        </p>
      </div>
      }
            ...
            >
              ...
              <div class="space-y-4">
                ...
                >
                  ...
                  >
                    ...
                    {{'{{authorName}}'}}, {{'{{prayerFor}}'}}, {{'{{status}}'}},
                    {{'{{actionDescription}}'}}, {{'{{denialReason}}'}},
                    {{'{{adminLink}}'}}, {{'{{appLink}}'}}
                  </p>
                </div>
              </div>
              ...
              <div class="space-y-4">
                ...
                <div>
                  ...
                  >
                  <p class="text-xs text-gray-600 dark:text-gray-400 mb-2">
                    Plain text version without formatting. Used for basic email
                    clients and accessibility. Should match the HTML version
                  </p>
                  <textarea
                ...
                >
                  ...
                  >
                    ...
                    <li>
                      ...
                      <code class="text-[10px]">APP_URL</code>; prayer reminders
                      + <strong>user_hourly_prayer_reminder</strong>)
                    </li>
                    <li>
                      • {{'{{unsubscribe_url}}'}} - Personalized unsubscribe
                      link (queued + most transactional emails; omit from
                      templates that should not offer list unsubscribe)
                    </li>
                  </ul>
                </div>
              </div>
