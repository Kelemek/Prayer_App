...
@Component({
  ...
  template: `
    <app-admin-collapsible-section
      ...
      triggerId="backup-status-trigger"
      panelId="backup-status-panel"
    ...
    >
      ...
      @if (loading) {
        <app-admin-section-loading message="Loading backup status…" />
          ...
          <div class="space-y-2">
            ...
            <div>
              ...
              >
                ...
                } @if (backup.tables_backed_up && getTableEntries(backup).length
                > 0) {
                <div>
                  <div
    ...
    <div
      appTopChromeOverlay
      class="fixed inset-0 bg-gray-900/50 flex items-start sm:items-center justify-center p-4 z-50 safe-area-overlay"
    >
      <div
