                ...
                <div class="relative max-w-lg">
                  ...
                  >
                    <button
                      ...
                      class="w-full flex items-center justify-between gap-2 p-2 sm:p-3 ui-motion-interactive ui-press cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed text-left"
                    >
