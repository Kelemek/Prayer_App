...
describe('PresentationSettingsModalComponent', () => {
  ...
  describe('Event Emitters', () => {
    ...
    it('should have categoriesChange event emitter', () => {
      expect(component.categoriesChange).toBeTruthy();
    });

    it('should have promptCategoriesChange event emitter', () => {
      expect(component.promptCategoriesChange).toBeTruthy();
    });
  });
});
