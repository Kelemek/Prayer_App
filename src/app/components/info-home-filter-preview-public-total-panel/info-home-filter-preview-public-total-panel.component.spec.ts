...
import { InfoHomeFilterPreviewPublicTotalPanelComponent } from './info-home-filter-preview-public-total-panel.component';
...
describe('InfoHomeFilterPreviewPublicTotalPanelComponent', () => {
  beforeAll(async () => {
  ...
  it('re-emits openHeaderPreview', () => {
    ...
    fixture.componentInstance.openHeaderPreview.emit('search');
