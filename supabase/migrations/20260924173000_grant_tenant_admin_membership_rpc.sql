-- Grant tenant_admin on tenant_memberships via SECURITY DEFINER (MFA / p_email callers).
...
grant execute on function public.grant_tenant_admin_membership(uuid, text, text, text) to anon, authenticated, service_role;
