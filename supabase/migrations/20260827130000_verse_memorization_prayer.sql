-- Verse memorization of the week: tenant-scoped community prayers + per-tenant email template.
...
-- Seed verse_memorization_prayer template for every tenant (cloned to new orgs via ensure_tenant_email_templates).
