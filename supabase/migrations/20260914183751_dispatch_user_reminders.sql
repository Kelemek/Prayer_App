-- Single cron dispatcher for user reminder Edge Functions (sequential invoke).
-- Replaces three parallel jobs:
--   invoke-user-hourly-prayer-reminders (0 * * * *)
--   invoke-user-hourly-memorization-reminders (0 * * * *)
--   invoke-user-prayer-item-reminders (*/15 * * * *)
